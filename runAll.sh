...
sbatch --time=72:00:00 --wrap "module purge;ml Singularity/3.11.3;singularity run --bind /nemo:/nemo,/camp:/camp /nemo/stp/babs/working/boeings/singularity_images/r431.ubuntu.22.04.sif Rscript runQt.r;" --job-name=$project -p hmem --mem=600G -o ../../../../workdir/rB.$project.slurm >> ../commands.txt
cd -

wait_on_lsf
project=rDGEM_$project_id
cd ./analyses/DGE_Marker_Analysis/
#sbatch --time=72:00:00 --wrap "module purge;source /camp/stp/babs/working/software/modulepath_new_software_tree_2018-08-13;module load pandoc/2.2.3.2-foss-2016b;ml R/4.0.3-foss-2020a;Rscript runRmd.r Main_Analysis.Rmd" --job-name=$project -p hmem --mem=1500G -o ../../../../workdir/rB.$project.slurm >> ../commands.txt
sbatch --time=72:00:00 --wrap "module purge;ml Singularity/3.11.3;singularity run --bind /nemo:/nemo,/camp:/camp /nemo/stp/babs/working/boeings/singularity_images/r431.ubuntu.22.04.sif Rscript runQt.r;" --job-name=$project -p hmem --mem=600G -o ../../../../workdir/rB.$project.slurm >> ../commands.txt
cd -
